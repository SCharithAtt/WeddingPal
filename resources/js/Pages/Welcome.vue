<template>
    <div class="min-h-screen flex flex-col">
        <!-- Header Section - 20vh -->
        <header class="h-[20vh] bg-white/80 backdrop-blur-md shadow-md w-full">
            <!-- Navbar -->
            <nav class="flex justify-between items-center p-4 h-full bg-gradient-to-r from-white via-gray-50 to-gray-100  ">
                <!-- Logo Container -->
                <div class="flex items-center">
                    <Link :href="'/'">
                        <svg class="logo-svg w-2/3 h-auto"
                             version="1.0"
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    <a @click.prevent="loadComponent(FindVendors)" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        Find Vendors
                    </a>
                    <a @click.prevent="loadComponent(WeddingInspo)" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        Wedding Inspiration
                    </a>
                    <a @click.prevent="loadComponent(DestinationWeddings)" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        Destination Weddings
                    </a>
                    <a @click.prevent="loadComponent(WhyWeddingPal)" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        Why WeddingPal?
                    </a>
                    <a @click.prevent="loadComponent(AboutUs)" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        About Us
                    </a>
                    <Link :href="'/register/vendor'" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        Become a Vendor
                    </Link>
                </div>

                <!-- Icon Menu Section (Login/Register Buttons) -->
                <div class="flex items-center space-x-5">
                    <Link v-if="canRegister" :href="'/register/client'" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        <svg class="fill-current h-5 w-5 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <Link :href="route('login')" class="text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">
                        <svg class="fill-current h-5 w-5 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <!-- Content Section - 80vh -->
        <main class="flex-1 h-[80vh] overflow-auto">
            <component :is="currentComponent"></component>
        </main>
    </div>

    <!-- Footer Section -->
    <footer class="bg-gradient-to-r from-white via-gray-50 to-gray-100 text-gray-600 py-8">
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex space-x-8">
                        <a @click.prevent="loadComponent(FindVendors)" class="hover:text-blue-500">Find Vendors</a>
                        <a @click.prevent="loadComponent(WeddingInspo)" class="hover:text-blue-500">Wedding Inspiration</a>
                        <a @click.prevent="loadComponent(DestinationWeddings)" class="hover:text-blue-500">Destination Weddings</a>
                        <a @click.prevent="loadComponent(WhyWeddingPal)" class="hover:text-blue-500">Why WeddingPal?</a>
                        <a @click.prevent="loadComponent(AboutUs)" class="hover:text-blue-500">About Us</a>
                    </div>
                </div>

                <div class="flex space-x-6">
                    <Link :href="'/register/vendor'" class="hover:text-blue-500">Become a Vendor</Link>
                </div>
            </div>

            <!-- Social Media Section (optional) -->
            <div class="mt-4 flex justify-center space-x-6">
                <a href="#" class="text-gray-600 hover:text-blue-500">Facebook</a>
                <a href="#" class="text-gray-600 hover:text-blue-500">Instagram</a>
