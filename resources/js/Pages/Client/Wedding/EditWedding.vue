...
const form = useForm({
    bride: props.wedding.bride,
    groom: props.wedding.groom,
    date: props.wedding.date,
    time_from: props.wedding.time_from,
    time_to: props.wedding.time_to,
    venue: props.wedding.venue,
    number_of_guests: props.wedding.number_of_guests,
    contact_person_name: props.wedding.contact_person_name,
    contact_person_mobile: props.wedding.contact_person_mobile,
    notes: props.wedding.notes,
});
...
const submit = () => {
    form.put(`/wedding/${props.wedding.id}`, {
        onSuccess: () => {
